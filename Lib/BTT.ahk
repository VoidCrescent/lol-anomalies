...
btt(Text:="", X:="", Y:="", WhichToolTip:="", BulitInStyleOrStyles:="", BulitInOptionOrOptions:="")
{
  ...
  return BTT.ToolTip(Text, X, Y, WhichToolTip, 
    ...
    Type(BulitInStyleOrStyles) == "String" && BulitInStyleOrStyles != "" ? (%BulitInStyleOrStyles% ?? BulitInStyleOrStyles) : BulitInStyleOrStyles,
  Type(BulitInOptionOrOptions) == "String" && BulitInOptionOrOptions != "" ? (%BulitInOptionOrOptions% ?? BulitInOptionOrOptions) : BulitInOptionOrOptions
  )
}
